...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: process.env.SMTP_PASS || "cbkm ntdm cuvp vygh" // ⚠️ Use env vars in production
  }
});
...
router.post("/newpayment/register", (req, res) => {
  ...
  // 🔎 Validate date (must be within 30 days from today)
...
// ✅ GET all bookings for specific center
